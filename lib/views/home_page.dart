...
import '../common_widget/research_widget.dart';
                    ...
                    Stack(
                      children: [
                        ...
                        Expanded(
                          ...
                          ).box.padding(const EdgeInsets.symmetric(horizontal: 20, vertical: 20)).make(),
                        ).box.rounded.white.border(width: 0.6, color: Colors.black12).makeCentered(),
                        Align(
                            widthFactor: 4.2,
